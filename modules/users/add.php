            ...
            <div class="row">
                <div class="col">
                    <div class="form-group mg-form">
                        ...
                        <input name="fullname" type="fullname" class="form-control" placeholder="fullname" value=
                        "<?php
                    ...
                    <div class="form-group mg-form">
                        ...
                        <input name="phone" type="number" class="form-control" placeholder="Số điện thoại" value="
                        <?php
                        echo old("phone", $old) ?>">
                        <?php
